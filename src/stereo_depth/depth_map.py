                ...
                if check_sync(queues, new_msg.getTimestamp()):
                    for q in queues:
                        ...
                        if time_start+1 < time.time():
                            ...
                            H1 = genfromtxt('H1.dat', delimiter=',')
                            H2 = genfromtxt('H2.dat', delimiter=',')
                            fr1 = frame1.shape
                            fr2 = frame2.shape

                            img1_rectified = cv2.warpPerspective(frame1, H1, (fr1[1], fr1[0]))
                            img2_rectified = cv2.warpPerspective(frame2, H2, (fr2[1], fr2[0]))
